...
<<form action="/index.php/Admin/Category/category_add" method="post">
    <ul class="forminfo">
    <li><label>分类的名称</label><input name="cat_name" id="cat_name" type="text" class="dfinput" /><i class="i_name">名称不能超过15个字符</i></li>
    <li><label>分类的父级</label>
        <select name="cat_pid" id="cat_pid" class="dfinput">
    ...
    <li><label>是否显示</label><cite><input name="is_show" id="is_show" type="radio" value="1" checked="checked" />是&nbsp;&nbsp;&nbsp;&nbsp;<input name="is_show" type="radio" value="0" />否</cite></li>
