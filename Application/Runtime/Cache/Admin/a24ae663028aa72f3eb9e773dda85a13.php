...
<div class="place">
    ...
    <ul class="forminfo">
    <li><label>标题<b>*</b></label><input name="bg_title" type="text" class="dfinput" value=""  style="width:518px;"/><i>(50字以内)</i></li>
   
     <li><label>作者<b>*</b></label><input name="bg_author" type="text" class="dfinput" value="" size="20" style="width:518px;"/><i>(32字以内)</i></li>
    
    <li><label>分类<b>*</b></label>
        <div class="vocation">
            <select class="select1" name="cat_id"><option value="0">---请选择分类---</option>
                <?php
 foreach($catedata as $v){ ?>
                <option value="<?php echo $v['cat_id']?>"><?php echo str_repeat('--',$v['deep']).$v['cat_name']?></option>
                <?php
 } ?>
            </select>
        </div>
    ...
    <li><label>描述</label><textarea name="bg_excerpt" cols="" rows="" class="textinput"></textarea><i>(100字以内)</i></li>
	  
    <li><label>设置时间</label><input name="bg_time" type="text" readonly="readonly" class="dfinput" value="<?php echo date('Y-m-d H:i:s')?>"  style="width:518px;"/></li>
